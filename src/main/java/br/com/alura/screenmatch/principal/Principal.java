...
public class Principal {
    ...
    private final String API_KEY = "&apikey=9e7ded41";
...
//                .peek(e -> System.out.println("Pimeiro filtro(N/A)"))
//                .sorted(Comparator.comparing( (DadosEpisodio dado) -> dado.avaliacao()).reversed())
